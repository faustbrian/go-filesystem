...
`go-filesystem` is a capability-based, streaming filesystem abstraction for
...
- Remote adapters validate credentials, host identity, TLS, and root settings
  before use.
...
license file is added by the project owner.
